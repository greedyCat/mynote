...
public class TimeUtil {
	...
	public String toString() {
		return this.format(TimeUtil.CHN_DATE_TIME_EXTENDED_FORMAT);
	}
	 ...
	 * @return long
	 */
	public static long diffSec(TimeUtil mydate1, TimeUtil mydate2) {
	 ...
	 * @return int
	 */
	public static int diffDay(TimeUtil mydate1, TimeUtil mydate2) {
	...
	public static int diffDay(Date mydate1, Date mydate2) {
		mydate1 = TimeUtil.stringToDate(TimeUtil.dateFmtToString(mydate1, "yyyy-MM-dd"),"yyyy-MM-dd");
		mydate2 = TimeUtil.stringToDate(TimeUtil.dateFmtToString(mydate2, "yyyy-MM-dd"),"yyyy-MM-dd");
	...
	public static Date stringFmtToDate(String date) {
	...
	public static String pastTime(Date date) {
		...
		if (second<60) {
			...
			return TimeUtil.dateFmtToString(date,"yyyy-MM-dd HH:mm:ss");
		}
		
		
	}
	//传人过去时间
	public static String pastTime(String date) {
		int second = secondBetween(date);
		if (second<60) {
			if(second<10){
			  return "刚刚";	
			...
			return (second/60/60)+"小时前";
		} else if (second>24*60*60 && second < 24*60*60*30){
	...
	public static void main(String[] args){
		...
		//System.out.println(timeUtil.date2Calendar(new Date()).getWeeksInWeekYear());
		//System.out.println(timeUtil.pastTime("2015-11-28 09:20:22"));
//		System.out.println(timeUtil.getCurrentTime(new Date()));
//		System.out.println(CHN_DATE_TIME_EXTENDED_FORMAT.format(new Date()));
	}
}
